...
angular.module('paizaqaApp')
  .controller('TermsIndexComponent', function ($scope, $http, $location, Auth, query) {
    ...
    $http.get('/citizenpedia/api/terms', {params: {query: query}}).success(function(terms) {
      $scope.terms = terms;
    ...
    $scope.nextPage = function(){
      ...
      $http.get('/citizenpedia/api/terms', {params: {query: pageQuery}}).success(function(terms){
